...
OfflineLocation = 'Busy IRL'
PlayerToonName = 'Toon: %(toonname)s'
PlayerShowToon = 'Show Toon'
PlayerPanelDetail = 'Player Details'
AvatarPanelFriends = 'Companionship'
AvatarPanelWhisper = 'Message'
AvatarPanelSecrets = ''
AvatarPanelGoTo = 'Teleport'
AvatarPanelPet = 'Show Doodle'
AvatarPanelIgnore = 'Butthurt Button 1'
AvatarPanelIgnoreCant = 'Okay'
AvatarPanelStopIgnoring = 'Stop Ignoring'
AvatarPanelReport = 'Butthurt Button 2'
...
ReportPanelTitle = 'Cry about being stunk'
ReportPanelBody = 'This feature will send a complete report to nobody. Instead of sending a report, you might choose to do one of the following:\n\n  - Teleport to another district (There is only one)\n  - Use "Butthurt Button 1" on the toon\'s panel\n\nDo you really want to report %s to nobody?'
ReportPanelBodyFriends = 'This feature will send a complete report to nobody. Instead of sending a report, you might choose to do one of the following:\n\n  - Teleport to another district\n  - Break your companionship\n\nDo you really want to report %s to nobody?\n\n(This will also break your companionship)'
ReportPanelCategoryBody = 'You are about to report %s. Nobody will be alerted to your complaint and will take appropriate action for anyone breaking our rules. Please choose the reason you are reporting %s:'
...
ReportPanelCategoryLanguage = 'Saying "Fuck"'
ReportPanelCategoryPii = 'Asking for nudes'
ReportPanelCategoryRude = 'Saying "You Stink!"'
ReportPanelCategoryName = 'Racist Name'
ReportPanelCategoryHacking = 'Injecting'
...
ReportPanelWarning = "We take reporting very seriously. Your report will be viewed by nobody who will take appropriate action for anyone breaking our rules. If your account is found to have participated in breaking the rules, or if you make false reports or abuse the 'Report a Player' system, a Moderator may take action against your account. Are you absolutely sure you want to report this player?"
ReportPanelThanks = 'Thank you! Your report has been sent to nobody for review. There is no need to contact us again about the issue. The nobody team will take appropriate action for a player found breaking our rules.'
ReportPanelRemovedFriend = 'We have automatically removed %s from your Toon Friends List.'
ReportPanelRemovedPlayerFriend = 'We have automatically removed %s as a Player friend so as such you will not see them as your friend in any Toontown Infinite Source Code product.'
ReportPanelAlreadyReported = 'You have already reported %s during this session. Nobody will review your previous report.'
...
RewardPanelMeritsMaxed = 'Finished Grinding'
